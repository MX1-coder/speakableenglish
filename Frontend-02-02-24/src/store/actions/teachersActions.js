...
export const updateTeacher = createAsyncThunk(
  ...
  try {
    const response = await axios.post(`Update_Teacher/${teacherId}`, updatedData);
    // console.log(response)
    return response.data
  } catch (error) {
    console.log(error);
...
export const Update_Teacher_By_Availability = createAsyncThunk(
  ...
  async ({ teacherId, updatedData }) => {
  try {
    const response = await axios.post(`Update_Teacher_By_Availability/${teacherId}`, updatedData);
    // console.log(response)
    return response.data
  } catch (error) {
    console.log(error);
