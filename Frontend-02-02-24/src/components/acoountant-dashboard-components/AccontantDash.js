...
const AccontantDash = () => {
  ...
  useEffect(() => {
      ...
      const total = PaymentData.reduce((acc, payment) => acc + payment.Package_ID.Package_Amount, 0);
      ...
      const monthTotal = monthPayments.reduce((acc, payment) => acc + payment.Package_ID.Package_Amount, 0);
      ...
      const todayTotal = todayPayments.reduce((acc, payment) => acc + payment.Package_ID.Package_Amount, 0);
        ...
        <div className='Teacher-Dash_contnet_section_div'>
            ...
            <div className='Admin-Dash_contnet_section_div'>
                <img className='Admin-Dash_contnet_div_img'
                      ...
                      alt=''
                />
                <span className='Admin-Dash_contnet_head_div_span'>Packages Income</span>
            ...
            <div className='Admin-Dash_contnet_section_div'>
                    <img className='Admin-Dash_contnet_head_div_img'
                        ...
                        alt=''
                    />
                    <span className='Admin-Dash_contnet_head_div_span'>Session Income</span>
            ...
            <div className='Admin-Dash_contnet_section_div'>
                    <img className='Admin-Dash_contnet_head_div_img'
                        ...
                        alt=''
                    />
                    <span className='Admin-Dash_contnet_head_div_span'>Tody's Income</span>
            ...
            <div className='Admin-Dash_contnet_section_div'>
                    ...
                    <img className='Admin-Dash_contnet_head_div_img'
                        ...
                        alt=''
                    />
                    <span className='Admin-Dash_contnet_head_div_span'>Month Income</span>
