...
const AdminEditPackages = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.Package_Name || !formData.Teachers_ID.length || !formData.Course_ID.length || !formData.Package_Amount || !formData.Number_of_Lectures) {
      ...
      const emptyFieldName = !formData.Package_Name ? 'Package Name' :
        ...
        !formData.Course_ID.length ? 'Courses' :
        !formData.Package_Amount ? 'Purchase Price' : 'Number of Lectures';
    ...
    <>
      ...
      <ToastContainer position="top-right" autoClose={5000} hideProgressBar={false} />
        ...
        <div className="form-group">
            <label htmlFor="Package_Amount">Name of the Package</label>
            <input
              type="text"
