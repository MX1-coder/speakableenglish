...
//   console.log(teachers)
  ...
  const totalIncome = PaymentData.reduce((total, payment) => {
    if (payment.Status === "FULFILLED" && payment.Package_ID && payment.Package_ID.Package_Amount) {
      return total + payment.Package_ID.Package_Amount;
    }
    return total;
  }, 0);
                        ...
                        <thead className='table-transparent'>
                            ...
                            <tbody >
                                ...
                                <tr style={{boxShadow:'0px 2px 5px rgba(0, 0, 0, 0.2), 0 2px 5px 0 rgba(0, 0, 0, 0.1)'}} key={student._id}>
                                    ...
                                    ? <img src={`http://localhost:3000/images/${student.Profile_Image[0]}`} alt=""
                                    className='td_img'
                                />
