  ...
  return (
    <>
      <AdminNav
        ...
        placeholder={t("AdminStudent.placeholder")}
      />
      <div className="Student_mainPage_style">
        <div className="Student_header_style">
          <h6 className="text-dark">{t("AdminStudent.heading")}</h6>
          <Link to="/Admin-Dashboard/Students/add-student">
            <button className="btn btn-outline-success">
              {t("AdminStudent.AddStudent")}
            </button>
          </Link>
        </div>
        <div className="Teacher_list_style mt-3">
            ...
            filteredStudents?.map((student) => (
              <div key={student?._id} className="teacher_card">
                ...
                <button
                  ...
                  className="btn btn-outline-success"
                >
                  {t("AdminStudent.Profile")}
                </button>
              </div>
            ))
          ) : (
            <p> {t("AdminStudent.footer")}</p>
          )}
        </div>
      </div>
    </>
