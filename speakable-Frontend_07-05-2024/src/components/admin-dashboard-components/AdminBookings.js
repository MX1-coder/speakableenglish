  ...
  return (
    <>
      <AdminNav
        ...
        placeholder={t("AdminBookings.placeholder")}
      />

      <div className="Booking_mainPage_style">
        <div className="Booking_header_style">
          <h6 className="text-dark">{t("AdminBookings.heading")}</h6>
          ...
          {filteredBooking?.length > 0 ? (
            <table className="table table-hover table-responsive table-borderless">
              <thead className="table-transparent">
                <tr>
                  <th className="th">{t("AdminBookings.subheading1")}</th>
                  <th className="th">{t("AdminBookings.subheading2")}</th>
                  <th className="th">{t("AdminBookings.subheading3")}</th>
                  {/* <th className='th'>Meeting Link</th> */}
                  <th className="th">{t("AdminBookings.subheading4")}</th>
                  <th className="th">{t("AdminBookings.subheading5")}</th>
                  {/* <th className="th">TimeSlots</th> */}
                  <th className="th">{t("AdminBookings.subheading6")}</th>
                  <th className="th">{t("AdminBookings.subheading7")}</th>
