  ...
  return (
    <>
      ...
      <div className="AddStudentstyle">
        <h4>{t("AdminAddStudents.header")}</h4>
        <form onSubmit={handleSubmit}>
            ...
            <div className="col-6 col-sm-6 col-lg-3 mt-2 mt-md-0 mb-md-0 mb-2">
              <div className="card-body">
                <p style={{ fontSize: "12px" }} className="card-text">
                  {t("AdminAddStudents.Selectimage")}
                </p>
                {/* Basic file uploader */}
                <input
          ...
          <div className="form-group">
            <label htmlFor="Username">
              {t("AdminAddStudents.StudentFirstName")}
            </label>
            <input
              type="text"
              className="form-control"
            ...
            />
            <label htmlFor="Username">
              {t("AdminAddStudents.StudentLastName")}
            </label>
            <input
              type="text"
              className="form-control"
              ...
              required
            />
            <label htmlFor="Username">{t("AdminAddStudents.NickName")}</label>
            <input
              type="text"
              className="form-control"
              id="Nickname"
              ...
              required
            />
            <label htmlFor="Password">{t("AdminAddStudents.Email")}</label>
            <input
              type="Email"
              className="form-control"
              id="Email"
          ...
          <div className="form-group">
            <label htmlFor="Password">{t("AdminAddStudents.Password")}</label>
            <input
              type="password"
              className="form-control"
              id="Password"
          ...
          <div className="form-group">
            <label htmlFor="Phone_Number">
              {t("AdminAddStudents.PhoneNumber")}
            </label>
            <PhoneInput
              country={"us"}
              className="mt-2"
          ...
          <div className="form-group">
            <label htmlFor="Address">{t("AdminAddStudents.Address")}</label>
            <input
              type="text"
              className="form-control"
              id="Address"
