      ...
      <div className="AddCoursestyle">
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label htmlFor="Status">{t("AdminEditBooking.header")}</label>{" "}
            &nbsp;&nbsp;
            <select
              name="Status"
              value={status}
            ...
            >
              <option>{t("AdminEditBooking.SelectStatus")}</option>
