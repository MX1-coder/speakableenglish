...
const AdminEditStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(
        updateStudent({ student_ID, updatedData: updatedFormData })
      );
      navigate("/Admin-Dashboard/Students");
    } catch (error) {
      console.error("Error editing student:", error);
  ...
  return (
    <div className="Edit_Teachers_main_div">
      <h5>{t("AdminEditStudent.header")}</h5>
      <form onSubmit={handleSubmit}>
        ...
        {formData.Profile_Image?.length < 10 && (
          <div className="widthFormField">
            <div className="card-body">
              <p style={{ fontSize: "12px" }} className="card-text">
                {t("AdminEditStudent.Selectimage")}.
              </p>
              <input
                className="form-control widthFormField"
                encType="multipart/form-data"
        ...
        <div className="form-group">
          <label htmlFor="firstName">
            {t("AdminEditStudent.StudentFirstName")}
          </label>
          <input
            type="text"
            className="form-control"
        ...
        <div className="form-group">
          <label htmlFor="lastName">
            {t("AdminEditStudent.StudentLastName")}
          </label>
          <input
            type="text"
            className="form-control"
        ...
        <div className="form-group">
          <label htmlFor="Nickname">
            {t("AdminEditStudent.StudentNickname")}
          </label>
          <input
            type="text"
            className="form-control"
        ...
        <div className="form-group">
          <label htmlFor="Email">{t("AdminEditStudent.Email")}</label>
          <input
            type="email"
            className="form-control"
            id="Email"
        ...
        <div className="form-group">
          <label htmlFor="Password">{t("AdminEditStudent.Password")}</label>
          <input
            type="password"
            className="form-control"
            id="Password"
        ...
        <div className="form-group">
          <label htmlFor="Phone_Number">
            {t("AdminEditStudent.PhoneNumber")}
          </label>
          <PhoneInput
            country={"us"}
            className="mt-2"
        ...
        <div className="form-group">
          <label htmlFor="Address">{t("AdminEditStudent.Address")}</label>
          <input
            type="text"
            className="form-control"
            id="Address"
