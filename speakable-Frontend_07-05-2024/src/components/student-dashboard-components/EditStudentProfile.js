        ...
        <form>
            ...
            <div className="col-6 col-sm-6 col-lg-3 mt-2 mt-md-0 mb-md-0 mb-2">
              <div className="card-body">
                <p className="card-text">
                  {t("EditStudentProfile.Selectimage")}
                </p>
                <input
          ...
          <div className="form-group">
            <label htmlFor="FirstName">
              {t("EditStudentProfile.FirstName")}
            </label>
            <input
              type="text"
              className="form-control"
          ...
          {/* ---------------------last Name ------- */}
          <div className="form-group">
            <label htmlFor="lastName">{t("EditStudentProfile.LastName")}</label>
            <input
              type="text"
              className="form-control"
              id="lastName"
          ...
          <div className="form-group">
            <label htmlFor="Phone_Number">
              {t("EditStudentProfile.PhoneNumber")}
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="form-group">
            <label htmlFor="Address">{t("EditStudentProfile.Address")}</label>
            <input
              type="text"
              className="form-control"
              id="Address"
