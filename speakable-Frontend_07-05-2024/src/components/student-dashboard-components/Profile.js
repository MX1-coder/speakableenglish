        ...
        <div className="row">
          <div className="col-md-6 col-xs-12 ">
            <div className="userDetail">
              ...
              <div className="userDetailText">
                <p className="userDetailTextTitle">
          ...
          <div className="col-md-6 col-xs-12">
            <div className="userDetail">
              ...
              <div className="userDetailText">
                <p className="userDetailTextTitle">
                  {t("StudentProfile.hasOwncloudAccount")}:
                </p>
                <p className="userDetailTextData">
                  {student?.hasOwncloudAccount
                    ? "Yes - With Same Credentails"
                    : "No - Create one on click of Your Material Button"}
                </p>
              </div>
            </div>
          </div>
