    ...
    <>
      ...
      <div className="Package_mainPage_style">
        <div className="Package_header_style">
          <h6 className="text-dark">{t("StudentPackage.Packages")}</h6>
        </div>
              ...
              <div className="Package_card" key={index}>
                ...
                {pack?.Course_IDs?.map((val, idx) => (
                  <div key={idx}>
                    ...
                    <br />
                    <p style={{ margin: "auto" }} className="text-center w-75">
                      {val?.Description?.substring(0, 220)}
                    </p>
                  </div>
                ))}
                <h6 className="mt-4">{t("StudentPackage.TeachersAssigned")}</h6>
                ...
                <div className="d-flex flex-wrap justify-content-center w-100 mt-3 flexGAp">
                  <span className="Courses_card_teacher_span mx-1">
                    {t("StudentPackage.NumberofLectures")} :{" "}
                    {pack?.Number_of_Lectures}
                  </span>
                  <span className="Courses_card_teacher_span mx-1">
                    {t("StudentPackage.Amount")} : {pack?.Package_Amount}
                  </span>
                </div>
                <button
