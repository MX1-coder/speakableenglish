...
const Teacher = () => {
  ...
  console.log(Free_PackageDetails, "Free_PackageDetails");
                ...
                <div className="teachers_left_div">
                  <img
                    src={
                      ...
                      teacher?.Profile_Image?.length > 0
        ...
        <div className="d-flex justify-content-center align-items-center teachers_main_div">
          <div className="d-flex justify-content-center align-items-center teacher-data">
            <div className="teachers_left_div">
              ...
              <img
                src={
                  randomTeacher?.Profile_Image &&
                  randomTeacher?.Profile_Image.length > 0
                    ? `https://ik.imagekit.io/8s3jwexmv/${randomTeacher?.Profile_Image}`
                    : noimage
                }
                alt={randomTeacher?.Profile_Image || "Teacher Image"}
              />
            </div>
            <div className="teachers_right_div">
              <Link
