        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="form-group-sign">
            <input
              ...
              placeholder={t("FillResetPasswordPopup.ConfirmNewPassword")}
          ...
          <div className="d-flex mt-4">
            <button type="submit" className="btn btn-outline-success mx-3">
              {t("FillResetPasswordPopup.Submit")}
            </button>
            <button
            ...
            >
              {t("FillResetPasswordPopup.Close")}
            </button>
          </div>
        </form>
      </div>
