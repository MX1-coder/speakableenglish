...
const FillOTPPopup = ({ handleClose }) => {
  ...
  return (
    <>
      ...
      {FillResetPassword && (
        <FillResetPasswordPopup handleClose={closeFillResetPasswordFormPopup} />
      )}
    </>
  );
};
